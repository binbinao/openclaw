...
- Providers/Hunyuan: add bundled Hunyuan provider plugin with Tencent Hunyuan API support, `hunyuan-2.0-instruct-20251111` and `hunyuan-turbo` models, and standard API key authentication via `HUNYUAN_API_KEY`.
